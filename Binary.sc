...
def binaryAddition(pList: List[Int], qList: List[Int]) = {
  ...
  var convertList1 = convertIntListToBooleanList(pList.reverse)
  var convertList2 = convertIntListToBooleanList(qList.reverse)

  var output = doBinaryAddition(convertList1, convertList2, false).reverse

  var booleanToInt = convertBooleanListToIntList(output)
  booleanToInt
}
